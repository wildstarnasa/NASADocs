...
function RaidFrameLeaderOptions:Initialize(bShow)
	...
	self.wndMain = Apollo.LoadForm("RaidFrameLeaderOptions.xml", "RaidFrameLeaderOptionsForm", nil, self)
...
function RaidFrameLeaderOptions:FactoryProduce(wndParent, strFormName, tObject)
	...
	if not wndNew then
		wndNew = Apollo.LoadForm("RaidFrameLeaderOptions.xml", strFormName, wndParent, self)
