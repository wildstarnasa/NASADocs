...
-- Setting up the main keybind interface forms
	self.wndKeybindForm 	= Apollo.LoadForm(self.xmlDoc, "KeybindForm", nil, self) --this is the main form
...
function Keybind:OnShow()
	...
	self.wndKeybindForm:Show(true)
	self.wndKeybindForm:ToFront()
